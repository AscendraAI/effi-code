...
**CLI:** `effi` · **Version:** [`4.4.5`](VERSION)
...
<p>
  <img src="docs/assets/og-card.png" alt="effi-code — Top model where it counts. Cheap models everywhere else. Local when the meter runs out." width="720" />
</p>
